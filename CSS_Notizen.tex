...
\item Einwegfunktion\footnote{Eine Funktion deren Funktionswert $y=f(x)$ zu einem gegebenen x in polynomieller Zeit berechenbar ist, aber das Urbild $x$ zu einem gegebenen $y$ nicht in Polynomialzeit berechenbar ist}
