...
In einer RBAC Implementierung muss immer gelten, dass ein Subjekt nur in den Rollen aktiv sein, in denen es Mitglied ist und darf nur die Rechte der aktiven Rollen besitzen.\\
